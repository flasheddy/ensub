...
> **Historical status:** Milestone 5 was delivered and frozen at v0.2.0 as
> Ensub's PWA/Web Player reference prototype. This archived document preserves
> the accepted v0.2.0 product contract; active client requirements now live in
> the [Milestone 6 Android PRD](../prd.md).
...
| **Date** | 2026-08-19 |
| **Supersedes** | [Ensub v0.1.0 PRD and legacy roadmap](ensub-prd-v0.1.0.md) |
